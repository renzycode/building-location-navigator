    ...
    <div class="outer-canvas">
        <div id="zoom">
            ...
            <div class="inner-canvas">
                <img src="assets\images\floorplan 1st.png" alt="zoom" id="layout-image">

                <div>
                    <div class="office showhrmo" style="
                    ...
                    <span class="hover-pinlocation office showhrmo" style="
                ...
                <div>
                    ...
                    <span class="hover-pinlocation office showsupply" style="
                ...
                <div>
                    ...
                    <span class="hover-pinlocation office showhftc" style="
                ...
                <div>
                    ...
                    <span class="hover-pinlocation office showrled" style="
                    background-color: green;
                    top: 140px;
                    left: 825px;
                    "></span>
                ...
                <div>
                    <div class="office showresu" style="
                    animation: bounce 1s infinite;
                    color: #ffca2c;
                    top: 160px;
                    left: 495px;
                    ...
                    <span class="hover-pinlocation office showresu" style="
                    background-color: #ffca2c;
                    top: 160px;
                    left: 470px;
                    "></span>
                ...
                <div>
                    ...
                    <span class="hover-pinlocation office showhpac" style="
                    background-color: rgba(247, 0, 0, 0.3);
                    top: 230px;
                    left: 835px;
                    "></span>
...
">
        ...
        <div class="col-9">
            <div class="units rounded-0 shadow mb-2">
                <h3 class="units-title p-2 mb-0">FIRST FLOOR UNITS</h3>
                <div class="p-2">
                    ...
                    <span class="btn btn-warning rounded-0 p-0 px-1" onclick="goto(300,1000,4)"
                        style="font-size: 15px;">SBP</span>
                    
                </div>
            </div>
            <div class="units rounded-0 shadow mb-2 bounce d-none" id="hrmoprofiles">
                <h3 class="units-title p-2 mb-0">HRMO PROFILES</h3>
                <div class="p-2 m-2">
                    <div class="row">
            ...
            <div class="units rounded-0 shadow mb-2 bounce d-none" id="resuprofiles">
                <h3 class="units-title p-2 mb-0">RESU PROFILES</h3>
                <div class="p-2 m-2">
                    <div class="row">
    ...
    $(document).ready(function() {
        $(".showhrmo").click(function() {
            $("#hrmoprofiles").toggleClass("d-none");
        });
    })
    </script>
...
<script>
    $(document).ready(function() {
        $(".showresu").click(function() {
            $("#resuprofiles").toggleClass("d-none");
        });
    })
    </script>
