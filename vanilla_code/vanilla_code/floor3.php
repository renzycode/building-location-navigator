    ...
    <div class="outer-canvas">
        <div id="zoom">
            ...
            <div class="inner-canvas">
                <img src="assets\images\3rd.png" alt="zoom" id="layout-image">

                <div>
                    <div class="office showhfep" style="
                    ...
                    <span class="hover-pinlocation office showhfep" style="
                ...
                <div>
                    <div class="office showlhsd" style="
                    animation: bounce 1s infinite;
                    color: green;
                    top: 210px;
                    left: 790px;
                    ...
                    <span class="hover-pinlocation office showlhsd" style="
                ...
                <div>
                    <div class="office showfunction" style="
                    animation: bounce 1s infinite;
                    color: #0dcaf0;
                    top: 280px;
                    left: 530px;
                ...
                <div>
                    ...
                    <span class="hover-pinlocation office showhp" style="
                ...
                <div>
                    <div class="office showhfdc" style="
                    animation: bounce 1s infinite;
                    color: red;
                    top: 270px;
                    left: 720px;
                    ...
                    <span class="hover-pinlocation office showhfdc" style="
                    background-color: red;
                    top: 270px;
                    left: 700px;
                    "></span>
...
">
        ...
        <div class="col-9">
            <div class="units rounded-0 shadow mb-2">
                <h3 class="units-title p-2 mb-0">THIRD FLOOR UNITS</h3>
                <div class="p-2">
                    <span class="btn btn-danger rounded-0 p-0 px-1" onclick="goto(500,1000,4)"
                        style="font-size: 15px;">KM</span>
                    <span class="btn btn-info rounded-0 p-0 px-1" onclick="goto(300,1000,4)"
                        style="font-size: 15px;">FUNCTION</span>
                    <span class="btn btn-success rounded-0 p-0 px-1" onclick="goto(300,1000,4)"
                        style="font-size: 15px;">HFEP</span>
                    <span class="btn btn-primary rounded-0 p-0 px-1" onclick="goto(300,1000,4)"
                        style="font-size: 15px;">HP</span>
                    
                    <span class="btn btn-danger rounded-0 p-0 px-1" onclick="goto(300,1000,4)"
                        style="font-size: 15px;">HFDC</span>
                    <span class="btn btn-success rounded-0 p-0 px-1" onclick="goto(300,1000,4)"
                        style="font-size: 15px;">LHSD</span>
                </div>
            </div>

        
            <div class="units rounded-0 shadow mb-2 bounce d-none" id="hfepprofiles">
                <h3 class="units-title p-2 mb-0">HFEP PROFILES</h3>
                <div class="p-2 m-2">
                    <div class="row">
            ...
            <div class="units rounded-0 shadow mb-2 bounce d-none" id="lhsdprofiles">
                <h3 class="units-title p-2 mb-0">LHSD PROFILES</h3>
                <div class="p-2 m-2">
                    <div class="row">
            ...
            <div class="units rounded-0 shadow mb-2 bounce d-none" id="hpprofiles">
                <h3 class="units-title p-2 mb-0">HP PROFILES</h3>
                <div class="p-2 m-2">
                    <div class="row">
    ...
    $(document).ready(function() {
        $(".showhfep").click(function() {
            $("#hfepprofiles").toggleClass("d-none");
        });
    })
    </script>
...
<script>
    $(document).ready(function(){
        $(".showlhsd").click(function(){
            $("#lhsdprofiles").toggleClass("d-none");
        }) 
    })
</script>
...
<script>
    $(document).ready(function(){
        $(".showhp").click(function(){
            $("#hpprofiles").toggleClass("d-none");
        }) 
    })
</script>
